...
const marketplaceService = {
  ...
  materialListings: {
    ...
    create: (data) => api.post('/marketplace/material-listings/', data, {
      headers: { 'Content-Type': 'multipart/form-data' }
    }),
    update: (id, data) => api.patch(`/marketplace/material-listings/${id}/`, data, {
      headers: { 'Content-Type': 'multipart/form-data' }
    }),
    delete: (id) => api.delete(`/marketplace/material-listings/${id}/`),
    toggleFavorite: (id) => api.post(`/marketplace/material-listings/${id}/toggle_favorite/`),
    publish: (id) => api.post(`/marketplace/material-listings/${id}/publish/`),
    getReviews: (id) => api.get(`/marketplace/material-listings/${id}/reviews/`),
  },
  ...
  products: {
    ...
    toggleFavorite: (id) => api.post(`/marketplace/products/${id}/toggle_favorite/`),
  ...
  // ========== ORDERS ==========
  orders: {
    getAll: () => api.get('/marketplace/orders/'),
    getById: (id) => api.get(`/marketplace/orders/${id}/`),
    ...
    confirm: (id) => api.post(`/marketplace/orders/${id}/confirm/`),
    complete: (id) => api.post(`/marketplace/orders/${id}/complete/`),
    cancel: (id) => api.post(`/marketplace/orders/${id}/cancel/`),
  },
